...
from .completeness_reg import Ratio, Ratio_Bidirection
...
class ROIBoxHead_padreg(torch.nn.Module):
    ...
    def __init__(self, cfg, in_channels):
        ...
        self.ratio_estimator = ratio_est(cfg.MODEL.APNET.PADREG_AUG_PER, cfg.MODEL.APNET.PADREG_RAND_CUT)

        self.regcrit = EstLoss(loss="smooth_l1", bidirection=use_padreg_bidirection)

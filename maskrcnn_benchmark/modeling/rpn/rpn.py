...
class RPNModule(torch.nn.Module):
    ...
    def forward(self, images, features, targets=None, query=False, iteration=0):
        ...
        Arguments:
            ...
            query: useless, only in accordance with retinanet
...
def build_rpn(cfg, in_channels):
    ...
    if cfg.MODEL.FCOS_ON:
        raise NotImplementedError("The network based on FCOS has not been implemented")
        # return build_fcos(cfg, in_channels)
    elif cfg.MODEL.RETINANET_ON:
